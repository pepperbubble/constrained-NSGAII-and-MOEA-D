...
%产生下一代
    ...
    %越界处理
    Offspring(Offspring>MaxValue) = MaxValue(Offspring>MaxValue)-(MaxValue(Offspring>MaxValue)-MinValue(Offspring>MaxValue)*rand()); %子代越上界处理
    Offspring(Offspring<MinValue) = MinValue(Offspring<MinValue)+(MaxValue(Offspring<MinValue)-MinValue(Offspring<MinValue)*rand()); %子代越下界处理
end